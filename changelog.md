...
- Created wiki/index.md with categories: LLM Fundamentals, Prompt Engineering, RAG, AI Agents, Fine-Tuning, Guardrails, Benchmarking, GenAI Applications, Cloud AI Services, LLM Knowledge Bases
...
- Updated: wiki/index.md (added Software Engineering Philosophy category, total articles: 5)
